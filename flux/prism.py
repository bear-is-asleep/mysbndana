...
PRISM_VOLUMES = [PRISM_AREAS[i]*SBND_THICKNESS for i in range(len(PRISM_AREAS))]
PRISM_NT = [PRISM_VOLUMES[i]*ARGON_DENSITY*NUMBER_NUCLEONS for i in range(len(PRISM_VOLUMES))]
